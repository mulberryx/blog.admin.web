...
export class HomeComponent implements OnInit {
  ...
  ngOnInit() {
    let headlight = document.querySelector('#headlight'),
    ...
    TweenMax.to(ra, 1, {
      ...
      repeatDelay: 3,
      attr: {
        d: 'M169.35,172.71c20 0, 40 0, 80 0'
      }
    });
    ...
    TweenMax.to(ra, 1, {
      ...
      repeatDelay: 1,
      attr: {
        d: 'M169.35,172.71c0 0, 60 30, 55 -30'
      }
    });
    ...
    TweenMax.to(rcrp, .25, {
      ...
      yoyo: true,
      attr: {
        transform: 'rotate(20,186.3,231.38)'
      }
    });

    TweenMax.to(headlight, 1, {
      repeat: -1,
      yoyo: true,
      attr: {
        fill: '#ff0000'
